    ...
    <div className="mx-auto w-full max-w-4xl space-y-4">
      ...
      <div className="rounded-[28px] border border-black/10 bg-white/80 p-6 dark:border-white/10 dark:bg-white/[0.04]">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <div className="text-2xl font-black tracking-tight">Kullanım Şartları</div>
            <div className="mt-2 text-sm text-black/60 dark:text-white/60">
              HalApp (“Platform”) hizmetlerini kullanan tüm kullanıcılar bu şartları kabul etmiş sayılır.{" "}
          ...
          <div className="rounded-3xl border border-black/10 bg-black/5 p-4 dark:border-white/10 dark:bg-white/5">
            <div className="text-xs font-extrabold text-black/55 dark:text-white/55">Kısa Özet</div>
      ...
      <Card title="1) Tanımlar" subtitle="Şartlarda geçen bazı temel kavramlar.">
        <>
          <ul>
            ...
            <li>
              <b>Kullanıcı:</b> Platforma üye olan veya hizmetleri kullanan gerçek/tüzel kişi.
            </li>
            <li>
              <b>İlan:</b> Ürün/hizmet tanıtımı, fiyat, stok, görsel ve diğer içerikler.
            </li>
            <li>
              <b>Premium:</b> Ücretli özellikler (vitrin, öne çıkarma, gelişmiş araçlar vb.).
            </li>
          </ul>
        </>
      </Card>
      ...
      <Card title="2) Hizmetin Kapsamı" subtitle="HalApp ne sağlar, ne sağlamaz.">
        <>
          <p>
            HalApp; canlı ilan akışı, ilan yayınlama, favoriler, mesajlaşma ve kullanıcı profili gibi özellikler sunar.
            HalApp bir “pazar yeri” deneyimi sunar ancak satıcı/alıcı arasındaki anlaşmanın tarafı değildir.
          </p>
          <ul>
            <li>İlanların doğruluğundan, ürünün niteliğinden ve teslimat/ödeme süreçlerinden ilgili kullanıcı sorumludur.</li>
            <li>HalApp, şüpheli işlemleri güvenlik amacıyla inceleyebilir ve gerekli gördüğünde kısıtlama uygulayabilir.</li>
          </ul>
        </>
      </Card>

      <Card title="3) Üyelik ve Hesap Güvenliği" subtitle="Hesabın korunması ve sorumluluklar.">
        <>
          <ul>
      ...
      <Card title="4) İlan Kuralları" subtitle="Platformun kalitesini korumak için temel kurallar.">
        <>
          <ul>
            ...
            <li>Başkasına ait görsel/marka/kişisel veri paylaşımı için gerekli haklar kullanıcıya aittir.</li>
          </ul>
          <p>
            Kurallara aykırı içerikler kaldırılabilir, hesaplar kısıtlanabilir veya kapatılabilir.
          </p>
        </>
      </Card>
      ...
      <Card title="7) KYC / Doğrulama" subtitle="Kimlik doğrulama, güvenlik ve uyum.">
        <>
          <p>
            HalApp, güvenliği artırmak amacıyla kimlik doğrulama (KYC) isteyebilir. KYC sürecinde iletilen belgeler,
            KVKK & Çerez Politikası sayfasındaki aydınlatma kapsamında işlenir.
          </p>
          <p>
            KYC durumuna göre hesapta bazı özellikler kısıtlanabilir veya açılabilir.
          </p>
        </>
      </Card>
      ...
      <Card title="10) Uyuşmazlık ve Değişiklikler" subtitle="Şartların güncellenmesi.">
        <>
          <p>
            HalApp bu şartları güncelleyebilir. Güncellemeler platformda yayınlandığı andan itibaren geçerli olur.
          </p>
          <p>
            Uyuşmazlıklarda kullanıcı destek kanalı üzerinden çözüm aranır.
          </p>
        </>
      </Card>
      ...
      <div className="rounded-2xl border border-black/10 bg-black/5 px-4 py-3 text-xs text-black/60 dark:border-white/10 dark:bg-white/5 dark:text-white/60">
        Bu metin bilgilendirme amaçlıdır. KVKK ve Çerez tercihleriniz için <Link className="font-bold" href="/privacy">/privacy</Link> sayfasını kullanın.
      </div>
    </div>
  );
}