  ...
  return (
    <div className="mx-auto w-full max-w-3xl space-y-4">
      <div className="flex items-end justify-between gap-3">
        <div>
          <div className="text-2xl font-black tracking-tight">Yardım & Destek</div>
      ...
      <div className="rounded-[28px] border border-black/10 bg-white/80 p-6 dark:border-white/10 dark:bg-white/[0.04]">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2">
          ...
          <Item
            ...
            desc="Engellediklerini gör, engeli kaldır."
            href="/settings/blocked"
          />
          <Item
            title="Gizlenen İlanlar"
            desc="Gizlediğin ilanları gör, geri al."
            href="/settings/hidden"
          />
          <Item
            title="Şikayet / Sorun Bildir"
            desc="Spam/uygunsuz içerik bildir."
        ...
        <div className="mt-6 rounded-3xl border border-black/10 bg-white/70 p-5 dark:border-white/10 dark:bg-white/[0.03]">
          ...
          <div className="mt-3 space-y-3 text-sm text-black/70 dark:text-white/70">
            <div>
              <div className="font-extrabold">KYC neden gerekli?</div>
              <div className="mt-1 text-xs leading-5 text-black/60 dark:text-white/60">
                Güvenli ilan & mesajlaşma için kimlik doğrulama süreci. Belgeler Supabase Storage’da saklanır.
              </div>
            </div>

            <div>
              <div className="font-extrabold">Engellediğim kişi mesaj atabilir mi?</div>
              <div className="mt-1 text-xs leading-5 text-black/60 dark:text-white/60">
                Engellenen kullanıcı seni göremez/mesaj atamaz (RLS kurallarına bağlı).
              </div>
            </div>

            <div>
              <div className="font-extrabold">Hesabı silince ne olur?</div>
              <div className="mt-1 text-xs leading-5 text-black/60 dark:text-white/60">
                Kalıcı silme geri alınamaz. Bazı kayıtlar yasal zorunluluk nedeniyle anonim tutulabilir.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 px-4 py-3 text-xs font-semibold text-black/70 dark:text-white/70">
          Destek e-posta/kanalını istersen buraya ekleriz (örn: <b>support@halapp.tr</b>).
        </div>
      </div>
    </div>
  );
